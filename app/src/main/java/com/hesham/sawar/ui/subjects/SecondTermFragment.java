...
public class SecondTermFragment extends Fragment implements SubjectHomeAdapter.EventListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        facultySelectAdapter = new SubjectHomeAdapter(getContext(), this, facultyPojos, years, 2, depId);
...
//                startActivity(intent);
    ...
    public void addSubjects(String name) {//prefManager.getCenterId()
        SubjectPojo subjectPojo = new SubjectPojo(prefManager.getCenterId(), prefManager.getFacultyId(), years, 2, name, depId);
