 ...
 */
public class UnReadyOrderFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        facultySelectAdapter = new OrderUnReadyAdapter(getContext(),facultyPojos);
    ...
    public void getOrders() {//prefManager.getCenterId()
        Call<OrderResponse> call = Apiservice.getInstance().apiRequest.
                getUnreadyOrders(prefManager.getSubjectId());
